...
public class Montir extends AppCompatActivity {
    ...
    int[] listImg = new int[]{R.drawable.mt1, R.drawable.mt2, R.drawable.mt3, R.drawable.mt4,
            R.drawable.mt5, R.drawable.mt6, R.drawable.mt7, R.drawable.mt8, R.drawable.mt9, R.drawable.mt10};
